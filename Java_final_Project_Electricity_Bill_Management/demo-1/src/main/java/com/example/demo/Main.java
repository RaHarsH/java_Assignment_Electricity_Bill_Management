...
class DatabaseInsert {
    ...
    public static void insertCustomer(Customer customer) {
        try {
            String query = "INSERT INTO customers (cus_name, cus_address) VALUES (?, ?)";
            PreparedStatement preparedStatement = Main.connection.prepareStatement(query);
            preparedStatement.setString(1, customer.cus_name);
            preparedStatement.setString(2, customer.cus_address);
    ...
    public static void insertBill(Bill bill) {
        try {
            String query = "INSERT INTO bills (bill_number,unit_rate, units_consumed, isPaid) VALUES (?, ?, ?, ?)";
            PreparedStatement preparedStatement = Main.connection.prepareStatement(query);

            preparedStatement.setInt(1, bill.billNumber);
            preparedStatement.setDouble(2, bill.unitRate);
            preparedStatement.setInt(3, bill.unitsConsumed);
...
public class Main {
    ...
    public static void addCustomer() {
        ...
        DatabaseInsert.insertCustomer(customer);
    ...
    public static void enterBillDetails() {
        ...
        DatabaseInsert.insertBill(bill); 
